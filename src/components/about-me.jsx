      ...
      <div className="hidden md:block">
        ...
        <div className="flex gap-[59px] justify-between">
          <div className="flex flex-col gap-5 mt-[23px] [line-height:26px] text-[16px] max-w-[600px] text-[#ABB2BF]">
            <span>Hello, I’m Xayrullayevich Oyatulloh!</span>
            <span>
              I’m a Cyber Security Engineer, Full Stack Developer, and IT enthusiast based in ,
              Uzbekistan. I specialize in building secure and efficient web applications using
              TailwindCSS, HTML5, CSS, SASS, React, Redux, MySQL, and various cybersecurity practices.
              Additionally, I work with GitHub for version control and have expertise in database
              management, network engineering, system administration, and software engineering.
            </span>
            <span>
              Creating secure, innovative, and practical solutions has been my passion for years. I
              continuously explore new technologies and frameworks to enhance my skills and deliver
              high-quality, secure digital products.
            </span>
            <ReadMore />
          </div>
