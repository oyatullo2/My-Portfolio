    ...
    <>
      <div className="hidden md:flex justify-between">
        <div className="max-w-[537px] mt-[74px]">
          <h1 className="text-[32px] font-semibold">
            Xayrullayevich Oyatulloh is a{" "}
            <font className="main-color">Cyber Security Engineer</font>,{" "}
            <font className="main-color">Full Stack</font>,{" "}
            <font className="main-color">FrontEnd</font> and{" "}
            <font className="main-color">Backend Developer</font>
          </h1>
        ...
        <div className="relative">
          ...
          />
          <img
            className="max-w-[469px] ml-[56px] scale-110 top-[-19px] max-h-[386px] relative z-10"
            src="images/iam.png"
          />
          <img
      ...
      <div className="md:hidden flex flex-col gap-3 justify-between">
        ...
        <div className="relative w-full">
          ...
          />
          <img
            className="max-w-full ml-[56px] scale-110 top-[-19px] max-h-[386px] relative z-10"
            src="images/iam.png"
          />
          <img
            className="absolute left-0 top-[84px] z-0"
